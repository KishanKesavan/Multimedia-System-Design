    ...
    public void showIms(String[] args){
        ...
        try {
            ...
            for(int i=0;i<quantizationFactor;++i){
                rValues[i] = i*(256/quantizationFactor);
                for(int j=0; j<256/quantizationFactor; ++j){
                    if(red.get(i*(256/quantizationFactor)+j) != null && red.get(i*(256/quantizationFactor)+j) > red.get(rValues[i])){
                        rValues[i] = i*(256/quantizationFactor)+j;
                    }
                }
            }
            ...
            for(int i=0;i<quantizationFactor;++i){
                gValues[i] = i*(256/quantizationFactor);
                for(int j=0; j<256/quantizationFactor; ++j){
                    if(green.get(i*(256/quantizationFactor)+j) != null && green.get(i*(256/quantizationFactor)+j) > green.get(gValues[i])){
                        gValues[i] = i*(256/quantizationFactor)+j;
                    }
                }
            }
            ...
            for(int i=0;i<quantizationFactor;++i){
                bValues[i] = i*(256/quantizationFactor);
                for(int j=0; j<256/quantizationFactor; ++j){
                    if(blue.get(i*(256/quantizationFactor)+j) != null && blue.get(i*(256/quantizationFactor)+j) > blue.get(bValues[i])){
                        bValues[i] = i*(256/quantizationFactor)+j;
                    }
                }
            }
        ...
        JLabel lbText2 = new JLabel("Image before");
        lbText2.setHorizontalAlignment(SwingConstants.CENTER);
        JLabel lbText3 = new JLabel("Image after");
