...
public class QuantizeAndSubSample {
	...
	public void showIms(String[] args){
		...
		try {
			...
			int ySubSample = Integer.parseInt(args[1]);
			int uSubSample = Integer.parseInt(args[2]);
			int vSubSample = Integer.parseInt(args[3]);
			int quantizationFactor = Integer.parseInt(args[4]);
		...
		JLabel lbText2 = new JLabel("Image after sub sampling");
	...
	private int[][] upSample(int[][] subSampledYUV, int width, int height){
	...
	private int getAvg(int[] a, int index){
	...
	private int[][] subSample(int[][] givenYUV, int y, int u, int v, int width, int height){
	...
	private int[] getQuantizedRange(int quantizationFactor){
	...
	private int[][] quantizeRGB(int[][] unQuantizedRGB, int[] quantizedRange){
	...
	private int getClosestFromRange(int element, int[] range){
		int closestIndex = 0;
	...
	public static void main(String[] args) {
		QuantizeAndSubSample ren = new QuantizeAndSubSample();
		ren.showIms(args);
	}
